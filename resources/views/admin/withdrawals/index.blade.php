...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="h3 mb-0 text-gray-800">Permintaan Pencairan Saldo</h2>
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="py-3">
                                <span class="fw-bold text-success fs-5">Rp {{ number_format($wd->amount, 0, ',', '.') }}</span>
                            </td>
                            <td class="py-3">
            ...
            <div class="modal-content border-0 rounded-4 shadow">
                ...
                <div class="modal-body p-4">
                    <div class="bg-primary bg-opacity-10 text-primary p-3 rounded-3 mb-4 text-center">
                        ...
                        <h3 class="fw-bold mb-0 text-success">Rp {{ number_format($wd->amount, 0, ',', '.') }}</h3>
                    </div>
                    ...
                    <div class="d-flex gap-2 justify-content-end mt-4">
                        <!-- Reject Form -->
                        <form action="{{ route('admin.withdrawals.reject', $wd) }}" method="POST" class="d-inline flex-grow-1" onsubmit="return confirm('Yakin ingin menolak dan mengembalikan saldo ke pengguna?');">
                            @csrf
                            <input type="hidden" name="notes" value="Ditolak oleh Admin. Saldo dikembalikan.">
