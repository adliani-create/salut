            ...
            <form action="{{ route('admin.academic-schedules.store') }}" method="POST">
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        ...
                        <select name="type" class="form-select @error('type') is-invalid @enderror" required>
                            ...
                            <option value="diskusi" {{ old('type') == 'diskusi' ? 'selected' : '' }}>Diskusi</option>
                            <option value="tuweb" {{ old('type') == 'tuweb' ? 'selected' : '' }}>Tuweb (Tutorial Webinar)</option>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" value="{{ old('title') }}" placeholder="Contoh: MKDU4111 - Pendidikan Kewarganegaraan" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-text">Untuk Tugas/Diskusi, isi dengan jam mulai dibuka.</div>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="prodi_id" class="form-select @error('prodi_id') is-invalid @enderror">
                            ...
                            @foreach($programs as $program)
                                <option value="{{ $program->id }}" {{ old('prodi_id') == $program->id ? 'selected' : '' }}>{{ $program->nama }}</option>
                            @endforeach
                        </select>
                ...
                <div class="mt-5 text-end">
                    <button type="submit" class="btn btn-primary px-5 py-2 fw-bold">
                        <i class="bi bi-save me-1"></i> Simpan Jadwal & Broadcast
                    </button>
                </div>
            </form>
        </div>
